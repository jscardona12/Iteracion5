 ...
 * 
 */
public class Cobertizo extends Almacenamiento{
	...
	/**
	 * Método constructor de la clase cobertizo
	 ...
	 */
	public Cobertizo(int id, @JsonProperty(value="largo")int largo, @JsonProperty(value="ancho")int ancho) {
		super(id);
		this.largo = largo;
		this.ancho = ancho;
	}

	public Cobertizo(String estado, String tipo) {
		super(0,tipo,estado);
	}
